  ...
  if (error) {
    return (
      <div className="cabinet-workspace-page">
        ...
        <button onClick={fetchDashboard} className="btn btn-primary workspace-notice-actions">
  ...
  if (dashboardEmptyButHasEvents && hasMyEvents) {
    return (
      <div className="cabinet-workspace-page">
        ...
        <div className="workspace-inline-actions workspace-section-spacing">
        ...
        <div className="workspace-section-spacing">
          ...
          <div className="workspace-card-list">
            {myEvents.map((event) => (
              <Link
                ...
                className="workspace-card-link cabinet-event-title"
              >
                {event.title}
              </Link>
            ))}
