    ...
    <div className="signal-page-shell cabinet-workspace-page workspace-page-v2">
      ...
      <Panel variant="elevated" className="workspace-event-panel">
        <div className="workspace-hero-grid">
          <div className="workspace-cover-frame">
  ...
  return (
    <Panel variant="elevated" className="workspace-event-panel">
      ...
      <div className="signal-stack">
        ...
        <div className="workspace-slots-grid">
          {slots.map((slot: any) => (
            <SlotCard
              key={slot.slotIndex}
              locale={locale}
...
function SlotCard({
  ...
  return (
    <div
      className="workspace-slot-card"
      style={{
        ['--slot-card-border' as string]: border,
        ['--slot-card-bg' as string]: cardTone,
      }}
    >
      <div className="workspace-slot-card-header">
