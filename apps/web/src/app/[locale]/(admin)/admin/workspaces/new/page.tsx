...
import { FieldInput, FieldSelect, FieldTextarea, Notice, Panel } from '@/components/ui/signal-primitives';
...
export default function NewWorkspacePage() {
  ...
  return (
    <div className="signal-page-shell admin-control-page">
      <AdminPageHeader title={isRu ? 'Новый отдел' : 'New workspace'} subtitle={isRu ? 'Создайте отдел, подотдел, рабочую группу или партнёра.' : 'Create a department, subgroup, working group or partner.'} />
      <Panel>
