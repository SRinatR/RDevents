...
import { FieldInput, FieldSelect, Notice, Panel, SectionHeader } from '@/components/ui/signal-primitives';
...
export default function WorkspaceAccessPage() {
  ...
  return (
    <div className="signal-page-shell admin-control-page">
      <AdminPageHeader title={isRu ? 'Политики доступа' : 'Access policies'} subtitle={isRu ? 'Массовая выдача доступа всегда идёт через предпросмотр.' : 'Bulk access always goes through preview first.'} />
      <Panel>
