...
function SupportPageInner() {
  ...
  function handleCreated(thread: unknown) {
    ...
    router.push(`/${locale}/cabinet/technical-support/${t.id}`);
  }
  ...
  return (
    <div className="signal-page-shell cabinet-workspace-page workspace-page-v2">
      <PageHeader
        ...
        subtitle={
          locale === 'ru'
            ? 'Ваши технические обращения и переписка со службой поддержки'
            : 'Your technical tickets and correspondence with the support team'
        }
        actions={
