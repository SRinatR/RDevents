...
import { EmptyState, FieldInput, FieldTextarea, LoadingLines, Notice, PageHeader, Panel, SectionHeader, ToolbarRow } from '@/components/ui/signal-primitives';
import {
...
export default function CabinetEventWorkspaceView({ slug }: { slug: string }) {
...
function extractMissingFields(error: unknown): RegistrationMissingField[] {
