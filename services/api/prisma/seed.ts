...
async function main() {
  ...
  const singleEvent = await prisma.event.create({
    data: {
      ...
      fullDescription: `Квест создаётся как живое путешествие по русской культуре. Участники получают «Паспорт гостя Русского дома» и проходят шесть культурных пространств в составе команды из 5 человек — не больше и не меньше.
...
После прохождения всех точек команда открывает финальную страницу маршрута, участвует в награждении и становится частью общего праздничного события к юбилею Русского дома.`,
      ...
      endsAt: new Date('2026-05-03T10:30:00Z'),
